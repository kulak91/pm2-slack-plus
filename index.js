...
if (moduleConfig["SLACK_SIGNING_SECRET"] && moduleConfig["SLACK_BOT_TOKEN"] && moduleConfig["SLACK_PORT"]) {
  (async () => {
    await app.start();

    console.log(`Slack bot is ready. Listening on ${moduleConfig["SLACK_PORT"]} port.`);
  })();
}
